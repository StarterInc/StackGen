...
var Navigation = require('./components/Navigator');
var styles = require('./AppStyles');

// provides an easy way to test experimental features... TODO: remove after
// v.1.0
...
// console.log('AppRender store: ' + JSON.stringify(this.props.store))
  ...
  // <Image style={styles.appContainer} source={require(
	// '../starter/assets/background.png')} ></Image>
