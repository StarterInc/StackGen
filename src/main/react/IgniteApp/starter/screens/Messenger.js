...
class Messenger extends Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      this.handleReceive({
        text: "Interesting.  I will meet you with the statue in London for further analysis.",
        name: 'Indiana Jones',
    ...
    setTimeout(() => {
      this.handleReceive({
        text: "While we wait for analysis, we can coordinate with the Americans.",
        name: 'Indiana Jones',
        image: {uri: 'https://images.duckduckgo.com/iu/?u=http%3A%2F%2Fscout.rustedmagick.com%2Fsg1.gif&f=1'},
        position: 'right',
        date: new Date(2016, 3, 14, 13, 1),
    ...
    setTimeout(() => {
      this.handleReceive({
            ...
            name: 'Max Headroom',
            image: {uri: 'http://bigdecimal.online/wp-content/uploads/2016/07/iu.jpeg'},
            position: 'left',
            date: new Date(2016, 3, 14, 13, 1),
            uniqueId: Math.round(Math.random() * 10000), // simulating server-side unique id generation
          });
  ...
  render() {
    return (
      ...
      <AppBar title='Messages' navigator={this.props.navigator}/>
      <GiftedMessenger
