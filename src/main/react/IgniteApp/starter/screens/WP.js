...
var REQUEST_URL = 'http://bigdecimal.online/wp-json/wp/v2/posts/?filter[category_name]=Support%20Pages'; // '?filter[orderby]=rand&filter[per_page]=1';
...
var WP = React.createClass({
  ...
  renderArticles: function() {
    return (
      ...
      <AppBar title={strings.bigdecimal_help_training} navigator={this.props.navigator} closebutton={true}/>
          ...
          >
            {this.state.articles.map(article => (
              <Card
                ...
                // imageSource={'http://bigdecimal.online/wp-json/wp/v2/media/' + article.featured_media}
              ...
              <WebView
                ...
                source={{html:'<html><body style="font-family:helvetica; font-size:12;">' + article.content.plaintext + '</body></html>'}}
