...
public class Generator {
	 ...
	 * @throws Exception
	 */
	public static void initFromSpreadsheet(WorkBookHandle book)
			throws Exception {
	...
	public static void initMaps() {
		...
		componentMapNative.put("view",
				"<View style=${styles.component}>${content.component}</View>");

		componentMapWeb.put("view",
				"<Div style='${styles.component}'>${content.component}</Div>");
	...
	public static String getJSXFromJSON(JSONObject job) {
		...
		while (names.hasNext()) {
			...
			if (componentJSX != null) {
				...
				componentJSX = StringTool
						.replaceText(componentJSX, "${styles.component}",
		...
		// replace ${content}
		String componentCode = StringTool.replaceText(componentInitCodeNative,
		...
		// replace ${styles}
		String styleCode = StringTool.replaceText(styleInitCodeNative,
				"${styles}", styleString);
